...
?>
  ...
  <section class="about-hero">
    <div class="about-hero-half about-hero-visual">
      <img src="<?php echo esc_url($img . $data['hero']['portrait']); ?>" alt="<?php echo esc_attr($data['hero']['portrait_alt']); ?>">
    </div>
    <div class="about-hero-half about-hero-content">
      ...
      <p class="about-hero-text"><?php echo esc_html($data['hero']['text']); ?></p>
    </div>
  </section>
  ...
  <div class="about-sections">
    ...
    <section class="about-block<?php echo !empty($bloc['reverse']) ? ' about-block--reverse' : ''; ?>">
      <div class="about-half about-half--visual">
        <img src="<?php echo esc_url($img . $bloc['image']); ?>" alt="<?php echo esc_attr($bloc['image_alt']); ?>">
      </div>
